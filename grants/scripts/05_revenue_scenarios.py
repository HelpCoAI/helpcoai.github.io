...
def ad_revenue():
    ...
    print("  (a) DISPLAY ADS INSIDE THE APP -- real money, wrong placement")
    print("  " + "-" * 68)
    ...
    print()
    print("  $12-31k/yr at 50k users is NOT nothing -- it covers the entire infra")
    print("  line and then some. The honest caveats are timing and sourcing, not")
    print("  principle:")
    print("    - smallest exactly when you need it most ($2.5-6k at 10k users)")
    print("    - only meaningful at a scale where subscriptions already dwarf it")
    print("    - inside the logged-in product it competes with the paid upgrade")
    print("  Recommendation: skip ads in-product, run them on public content pages.")
    print()

    print("  (b) ADS ON PUBLIC CONTENT PAGES -- the version worth doing")
    print("  " + "-" * 68)
    ...
    print("  But this is traffic you are building anyway for organic acquisition, so")
    print("  the ad revenue is a byproduct rather than a distraction. At 100k monthly")
    print("  visits it covers infrastructure entirely.")
    print()
    print("  NON-NEGOTIABLE: hard blocklist on student lenders, loan refinancers, and")
    print("  for-profit colleges. Programmatic networks serve whoever bids highest,")
    print("  and in this vertical that is exactly the advertiser you cannot take money")
    print("  from while telling families you help them avoid debt. Expect to give up")
    print("  roughly half the RPM for that blocklist. Pay it.")
    print()
