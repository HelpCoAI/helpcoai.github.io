...
**Date:** 2026-08-06 · **Question:** run the scholarship platform as a 501(c)(3), free to all users, funded by foundations and government grants?
...
problem (which mostly isn't). For a 1-3 person team with no existing foundation relationships, that
trade is unfavorable at this stage.

---

## The precedents don't say what they appear to say
...
tech nonprofits are either single-mega-donor bets, structurally in deficit, or closed.** Nobody has
made "small, diversified-grant-funded, tech-first scholarship discovery" work.

---

## The funding math at your stage

**Realistic first-year grant funding for an unproven 1-3 person nonprofit: $5,000-$50,000.**
Sources: local community foundations, United Way, small family foundations (~45,000 US family
foundations give under $1M/yr, many with no formal process).
...
## Government money: survived the budget fight, still closed to you

**TRIO and GEAR UP were preserved.** The FY2026 budget proposed eliminating the entire $1.6B; Congress
rejected it. TRIO is funded at **$1.2B**, GEAR UP at **$388M**, roughly flat versus FY2025.
...
- Florida state programs (First Generation Matching Grant, FSAG) are need-based aid **to students**,
  not operating grants to tool builders.

---

## The real killer: founder time
...
Other constraints worth naming plainly:

- **Founder salary at a sub-$1M nonprofit: $45,000-$100,000**, median ~$61,000. Under $500K budget,
  realistically $50-70K. Going higher invites funder scrutiny.
- **No equity, no exit, ever.** IRS private-inurement rules prohibit profit share entirely. On
  dissolution, assets must transfer to another 501(c)(3). Your entire economic return is salary
  plus mission.
- **>30% of nonprofits dissolve within 10 years**, and that figure undercounts "zombie" orgs
  surviving on paper.
...
Nonprofit serves low-income users free; for-profit sells to schools, districts, and counselors.
This is legal and used in the sector, but requires: a majority-independent nonprofit board,
arm's-length fair-market-value contracts for any shared staff/tech/IP, and documented cost
allocation.
...
|---|---|---|
| What you must solve | ~30,000 free users to break even at $99/yr + sponsors | $200-400K/yr in recurring grants |
| Nature of the problem | Product and growth execution | Relationships and institutional sales cycles |
| Who controls it | **You** | Funders, on 12-24 month cycles, with renewal risk every 1-3 years |
| Your 990 pipeline | A defensible competitive edge | A pitch talking point |
...
This test costs a few weeks and no capital, and it works whether or not you ever incorporate.
